...
class ShougangDataset(data.Dataset):
    # refer from : 
    ...
    def next(self,path):
       ...
       # print(img_path)
        ...
        if ((frame is None) or (seg_g is None)):
            ...
            e = cv2.imread(self.mainpath+"/failsafe.jpg")
        ...
        crop_factor_h = self.rng.uniform(0.3, 0.35)
        ...
        for i in range(seg_g.max()):
            ...
            if(i != 0):
                ...
                if len(contours):    
                    ...
                    cv2.circle(seg_b,center,1,color = (1), thickness=-1, lineType=16)
